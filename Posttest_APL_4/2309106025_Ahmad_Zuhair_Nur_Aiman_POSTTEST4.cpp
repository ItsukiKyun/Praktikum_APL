#include <iostream>
#include <string>
#include <limits> // untuk membersihkan input buffer ketika input tidak valid
#include <sstream> // mengonversi string yang diambil dari input menjadi tipe data numerik
...
struct Tim {
    ...
    void HapusPemain(string namaPemain, int index = 0) {
        ...
        if (DataPemain[index].nama == namaPemain) {
            ...
            HapusPemain(namaPemain, index + 1);
        }
    }
};
